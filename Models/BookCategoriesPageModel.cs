...
namespace Baghiut_Ioana_Lab8.Models
{

    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Baghiut_Ioana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Baghiut_Ioana_Lab8Context context,
